...
<body>
  <div class="container">
    ...
    <form method="post" action="/options">
      ...
      <!-- Páginas Extras (ninguna preseleccionada) -->
      ...
      <!-- Productos (solo para ecommerce, predeterminado: 50) -->
      <?php if (\$_SESSION['site_type'] === 'ecommerce'): ?>
